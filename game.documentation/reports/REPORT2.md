# Report 2
Report 2 is written as if you were publishing the game for other instructors and students. It must allow someone else to set up, understand and run your game, especially the short version for Game Day (~20 minutes).
...
how to lay out the board/cards/materials
how roles or teams are assigned
anything that must be done before the first turn starts

## Narrative/Scenario
Use a short text to set the scene. Clarify:
Who are the players?
